...
if (!factories.has('dsh-balance-by-token')) {
  console.error('verify-client FAIL: bundle 未注册 "dsh-balance-by-token" 工厂')
  process.exit(1)
}
...
const edges = new Set()
const exports = factories.get('dsh-balance-by-token')(makeRequire(edges))
const mod = exports || {}

const shapeOk = mod.name === 'dsh-balance-by-token' && typeof mod.apply === 'function' && Array.isArray(mod.inject)
if (!shapeOk) {
