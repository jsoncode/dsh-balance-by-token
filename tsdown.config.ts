/**
 * dsh-balance-by-token —— tsdown 构建配置（与 dsh-jenkins 相同的 client bundle 方案）。
 *
 * 两个产物：
...
const clientConfig: UserConfig = {
  name: 'dsh-balance-by-token/client',
  ...
  banner: `window.__ModuleLoader__.load({ id: 'dsh-balance-by-token', factory: (require) => {
